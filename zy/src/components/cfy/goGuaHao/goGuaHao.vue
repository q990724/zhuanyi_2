   ...
   <div class="goGuaHao">
      ...
      <div class="search">
         <van-row>
            ...
            <van-col span="4">
               <van-dropdown-menu>
                  <van-dropdown-item v-model="searchType" :options="searchList"/>
               </van-dropdown-menu>
            </van-col>
         </van-row>
      </div>
            ...
            <van-col span="19" class="content">
               <van-row class="left">
                  <van-col span="19">
                     ...
                     <p>避免挂错科室 / 节省就医成本</p>
                     <div class="bottom">已有<span>366.4</span>万名患者在<span>挂号前</span>选择诊前咨询</div>
                  </van-col>
...
export default {
   data(){
      return{
         searchVal : "",
         searchType : 0,
         searchList : [{ text: '北京', value: 0 },{ text: '科室', value: 1 },{ text: '医生', value: 2 }],
         choose1 : 0,
         choose2 : 0,
         choose1_list : [
            { text: '综合排序', value: 0 },
